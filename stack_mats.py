...
for from_ in [5000,15000,20000,25000,30000,35000,40000,45000,50000,55000,60000,65000,70000,75000]:#10000
    if from_ == 75000:
...
print len(result)
print len(result['functions'])
savemat('/var/scratch/spintea/Repositories/ms-caffe/data/selective_search_data/mscoco_train.mat',result)
