...
#        exit()
    ...
    for tree_level_size in range(1,2):
        #initialize
        print 'initializing'
        sgd = SGD.SGD('max', category, tree_level_size, batch_size, math.pow(10,-3), 0.003, math.pow(10,-5))
        ...
        for i_img_nr, img_nr in enumerate(training_data[0:20]):
