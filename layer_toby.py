...
from roi_data_layer.minibatch_toby import get_minibatch
import numpy as np
import yaml
...
class RoIDataLayer(caffe.Layer):
    ...
    def setup(self, bottom, top):
        ...
        if cfg.TRAIN.HAS_RPN:
            ...
            top[idx].reshape(1,21)
            self._name_to_top_map['labels'] = idx
            idx += 1
            #self._name_to_top_map['functions'] = idx
            #idx += 1
            ...
            self._name_to_top_map['overlaps'] = idx
            idx += 1
...
#            if blob_name == 'functions':
#                blob =  blob.reshape(3 * 2, 1000,1,1)
